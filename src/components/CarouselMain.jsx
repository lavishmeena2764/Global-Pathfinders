    ...
    <Slider {...settings}>
      <div className="relative h-screen flex items-center justify-center text-center">
        ...
        <div className="relative z-10 p-8 mt-24 md:mt-56">
          <h2 className="text-6xl font-bold text-white">Begin Your Academic Journey with Us</h2>
      ...
      <div className="relative h-screen flex items-center justify-center text-center">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="relative z-10 p-8 mt-24 md:mt-56">
          <h2 className="text-6xl font-bold text-white">Expert Guidance for International Admissions</h2>
      ...
      <div className="relative h-screen flex items-center justify-center text-center">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="relative z-10 p-8 mt-24 md:mt-56">
          <h2 className="text-6xl font-bold text-white">Personalized and Unbiased Advice</h2>
