...
const Carousel = () => {
    const cards = [
        {
            image: 'https://globalpathfinders.co.in/assets/images/courses/courses-img8.jpg',
        ...
        {
            image: 'https://globalpathfinders.co.in/assets/images/courses/courses-img9.jpg',
        ...
        {
            image: 'https://globalpathfinders.co.in/assets/images/courses/courses-img7.jpg',
    ...
    return (
        ...
        <Slider {...settings}>
            {cards.map((card, index) => (
                <div key={index}>
                    <div className="bg-white shadow-xl rounded-lg p-4 m-3 program-card">
